                ...
                <div className="flex flex-wrap md:flex-nowrap md:space-x-1 md:justify-start">
                    <button
                        className={`px-8 py-5 font-bold text-sm rounded-lg ${
                            activeTab === "college" ? "bg-blue-600 text-white" : "bg-gray-200 text-black hover:bg-blue-600 hover:text-white"
                        }`}
                    ...
                    <button
                        className={`px-8 py-5 font-bold text-sm rounded-lg ${
                            activeTab === "accommodation" ? "bg-blue-600 text-white" : "bg-gray-200 text-black hover:bg-blue-600 hover:text-white"
                        }`}
